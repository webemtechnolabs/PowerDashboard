...
(function() {
  angular.module('angularPaho').factory('MqttClient', [function() {
    ...
    client._username = "";
    client._password = "";
    client._reconnectInterval = 10000;

    client._connectionLostCallback = null;
    ...
    function onConnectionLost(resp) {
      ...
      if (client._connectionLostCallback) {
          client._connectionLostCallback(resp);
      }
    }
    ...
    function isConnected() {
        return client._client.isConnected();
    }
    ...
    function init(location, port, id, onMessage, reconnectinterval, connectionLostCallback) {
      // initialize attributes
      client._location = location;
      client._port = port;
      client._id = id;
      client._reconnectInterval = reconnectinterval;

      if (connectionLostCallback) {
          client._connectionLostCallback = connectionLostCallback;
      }
      ...
      client._client.onMessageArrived = onMessage;
    }
